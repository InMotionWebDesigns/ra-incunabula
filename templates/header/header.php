		...
		<div class='boldgrid-section'>
			<div class="bgtfw <?php echo $configs['template']['pages']['global']['header']; ?>">
				...
				<div class='row header-6 header-7'>
					<div class='col-sm-12 col-md-12 header-6'><?php do_action( 'boldgrid-theme-location', 'header', '6' ); ?></div>
					<div class='col-sm-12 col-md-12 header-7'><?php do_action( 'boldgrid-theme-location', 'header', '7' ); ?></div>
				</div>
